  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="rounded-[1.5rem] border border-white/10 bg-white/10 p-4 sm:rounded-[2rem] sm:p-5">
          ...
          <p className="mt-3 text-slate-300">
            Tell us about your environment, your challenges, and the outcomes
            you want to achieve.
          </p>
          <div className="mt-6 grid gap-3 sm:grid-cols-3">
            <Link
              href="mailto:info@tidal-iot.com"
              aria-label="Email Tidal IoT Solutions"
            ...
            >
              <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[var(--brand-success)]/15 text-[var(--brand-success)] transition group-hover:bg-[var(--brand-success)] group-hover:text-[var(--brand-primary)]">
            ...
            <Link
              href="/contact"
              aria-label="Find Tidal IoT Solutions in Nairobi"
              className="group flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 p-3 transition hover:border-[var(--brand-success)]/50 hover:bg-white/10"
            >
              <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[var(--brand-success)]/15 text-[var(--brand-success)] transition group-hover:bg-[var(--brand-success)] group-hover:text-[var(--brand-primary)]">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <Link
              href="mailto:info@tidal-iot.com"
              className="inline-flex items-center justify-center break-all rounded-full bg-[var(--brand-success)] px-5 py-3 font-semibold text-[var(--brand-primary)] transition hover:bg-[var(--brand-success)]"
            >
              info@tidal-iot.com
            </Link>
            <Link
      ...
      <div className="mx-auto mt-8 flex max-w-7xl flex-col gap-2 border-t border-white/10 pt-5 text-sm text-slate-400 sm:flex-row sm:items-center sm:justify-between">
        <p className="brand-color-flow">
          &copy; {new Date().getFullYear()} Tidal IoT Solutions. All rights
          reserved.
        </p>
