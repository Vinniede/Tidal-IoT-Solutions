...
const faqItems = [
  {
    ...
    answer:
      "Yes. We secure branch networks, remote staff access, and transaction systems with enterprise-grade connectivity and monitoring.",
  },
  {
    question: "How do you help with financial compliance?",
    answer:
      "We build systems that provide the visibility and security controls needed to support regulatory reporting and audits.",
  },
  {
    question: "Can you protect cash operations and transaction flows?",
    answer:
      "Our solutions help safeguard branch operations, ATMs, and payment systems with secured backhaul and resilient networks.",
  },
];
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="max-w-2xl text-slate-600">
                  We help banks and financial institutions secure branch
                  networks, protect remote teams, and keep digital services
              ...
              <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
                ...
                <h2 className="mt-6 text-3xl font-semibold text-[#0B1F3A]">
                  Secure infrastructure for financial operations.
                </h2>
                <p className="mt-4 text-slate-600">
                  Protect sensitive data, ensure uptime, and maintain compliance
                  across your branch and digital services.
                </p>
              </div>
            </div>
          ...
          <div className="relative mx-auto max-w-7xl grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-stretch">
            <div className="rounded-[2rem] border border-white/10 bg-transparent p-10 text-white shadow-2xl flex flex-col gap-6">
              ...
              <p className="mt-2 text-white font-semibold">
                ...
                protect sensitive transactions, and support distributed teams
                with confidence.
              </p>
              <div className="w-full max-w-xs rounded-lg bg-white/5 p-4">
                ...
                <p className="mt-3 text-slate-200 text-sm">
                  Secure operations for branches, back-office, and digital
                  channels.
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="space-y-6">
                ...
                <p className="max-w-2xl text-slate-300">
                  ...
                  disruptions, faster service, and more trust from customers.
                </p>
              </div>
              <div className="mt-8">
          ...
          <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-center">
            <div className="rounded-[2rem] border border-slate-200 bg-[#0B1F3A] p-10 text-white shadow-xl">
              ...
              <h2 className="mt-5 text-3xl font-semibold">
                Branch network hardening for a regional bank.
              </h2>
              <div className="mt-8 space-y-6 text-slate-300">
                <div>
                  <p className="font-semibold text-white">Challenge</p>
                  <p className="mt-3">
                    A bank network needed stronger branch security and reliable
                    transaction connectivity for remote teams.
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-white">Solution</p>
                  <p className="mt-3">
                    We deployed secure networking, encrypted access, and
                    monitoring for branch and remote operations.
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-white">Results</p>
                  <p className="mt-3">
                    The bank achieved higher branch uptime and improved risk
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-10 shadow-sm">
              <Image
                src="/images/deployment-photo.png"
                alt="Financial services deployment"
                width={640}
                height={520}
                className="rounded-[1.75rem] object-cover"
                priority
        ...
        <section className="bg-[#0B1F3A] px-6 py-24 text-white sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl rounded-[2rem] border border-white/10 bg-[#6E1E2D] p-14 text-center shadow-[0_30px_80px_rgba(7,26,47,0.22)]">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">
              Protect your financial network with Tidal.
            </h2>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Talk to our team about a secure infrastructure strategy for your
              banking operations.
            </p>
