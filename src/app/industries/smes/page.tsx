...
const galleryImages = [
  {
    ...
    description: "A polished, connected workspace built for secure collaboration.",
  },
  {
    src: "/images/SMEs/Startup workspace.jfif",
    title: "Startup workspace",
    description: "Flexible infrastructure that supports fast-growing teams and evolving needs.",
  },
  {
    src: "/images/SMEs/Cloud collaboration.jfif",
    title: "Cloud collaboration",
    description: "Simplified access and collaboration for remote and hybrid teams.",
  },
  {
    src: "/images/SMEs/Small business technology.jfif",
    title: "Small business technology",
    description: "Practical technology design that keeps operations efficient and dependable.",
  },
];
      ...
      <main>
        <section className="bg-white px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-[0.95fr_1.05fr] items-center">
            ...
            <div className="relative h-full min-h-[420px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl"><Image src="/images/SMEs/Startup workspace.jfif" alt="SME operations" fill sizes="(min-width: 1024px) 45vw, 100vw" className="object-cover object-center" quality={100} priority /></div>
          </div>
        </section>
        ...
        <section className="relative isolate overflow-hidden px-6 py-24 sm:px-8 lg:px-12">
          <div className="absolute inset-0 -z-10">
            <Image src="/images/SMEs/Cloud collaboration.jfif" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} />
          </div>
          <div className="relative mx-auto max-w-7xl grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-stretch">
            <div className="rounded-[2rem] border border-white/10 bg-transparent p-10 text-white shadow-2xl flex flex-col gap-6">
              <SectionHeading
                ...
                titleClassName="text-[#0EA5E9]"
                descriptionClassName="text-[#93C5FD]"
              />
              ...
              <div className="w-full max-w-xs rounded-lg bg-white/5 p-4">
                ...
                <p className="mt-3 text-slate-200 text-sm">Practical systems for small teams that need reliability.</p>
              </div>
            </div>
        ...
        <section className="relative isolate overflow-hidden px-6 py-24 sm:px-8 lg:px-12">
          <div className="absolute inset-0 -z-10">
            <Image src="/images/SMEs/Small business technology.jfif" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} />
        ...
        <section className="bg-white px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[0.95fr_1.05fr] items-center">
            ...
            <div className="relative h-full min-h-[420px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl">
              <Image src="/images/SMEs/Cloud collaboration.jfif" alt="SME key features visual" fill sizes="(min-width: 1024px) 40vw, 100vw" className="object-cover object-center" quality={100} />
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#071A2F] px-6 py-24 text-white sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[1.05fr_0.95fr] items-center">
            ...
            <div className="relative h-full min-h-[420px] overflow-hidden rounded-[2rem] border border-white/10 shadow-xl">
              <Image src="/images/deployment-photo.png" alt="SME benefits visual" fill className="object-cover object-center" />
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-stretch">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-[#F8FBFC] p-10 shadow-sm h-full min-h-[420px]">
                <Image src="/images/SMEs/Modern business office.jfif" alt="SME technology" width={640} height={520} className="rounded-[1.75rem] object-cover" priority />
            </div>
          </div>
        </section>
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              {relatedIndustries.map((industry) => (
                ...
                >
                  ...
                  <p className="mt-4 text-slate-200 font-medium">Explore how Tidal supports related infrastructure needs.</p>
                </Link>
              ))}
            </div>
          </div>
