...
const galleryImages = [
  {
    ...
    description: "Reliable infrastructure that supports essential services and continuity.",
  },
  {
    src: "/images/Utilities/Smart grid.jfif",
    title: "Smart grid",
    description: "Connected systems for better visibility, control, and operational insight.",
  },
  {
    src: "/images/Utilities/Energy network.jfif",
    title: "Energy network",
    description: "Distributed assets and energy flows presented in a clear operational view.",
  },
  {
    src: "/images/Utilities/Utility monitoring.jfif",
    title: "Utility monitoring",
    description: "A strong visual foundation for monitoring and rapid response workflows.",
  },
];
      ...
      <main>
        <section className="bg-white px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-[0.95fr_1.05fr] items-center">
            ...
            <div className="relative h-full min-h-[420px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl"><Image src="/images/Utilities/Energy network.jfif" alt="Utility operations" fill sizes="(min-width: 1024px) 45vw, 100vw" className="object-cover object-center" quality={100} priority /></div>
          </div>
        </section>
        ...
        <section className="relative isolate overflow-hidden px-6 py-24 sm:px-8 lg:px-12">
          <div className="absolute inset-0 z-0">
            <Image src="/images/Utilities/Power transmission.jfif" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} priority />
          </div>
          <div className="relative z-10 mx-auto max-w-7xl grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-stretch">
            <div className="rounded-[2rem] border border-white/10 bg-transparent p-10 text-white shadow-2xl flex flex-col gap-6">
              ...
              <div className="w-full max-w-xs rounded-lg bg-white/5 p-4">
                ...
                <p className="mt-3 text-slate-200 text-sm">Resilient operations for energy, water, and infrastructure providers.</p>
              </div>
            </div>
        ...
        <section className="bg-[#F8FBFC] px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[0.95fr_1.05fr] items-center">
            ...
            <div className="relative min-h-[480px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl">
              <Image src="/images/Utilities/Utility infrastructure.jfif" alt="Utility challenges visual" fill sizes="(min-width: 1024px) 40vw, 100vw" className="object-cover object-center" quality={100} />
            </div>
          </div>
        </section>
        ...
        <section className="bg-white px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[0.95fr_1.05fr] items-center">
            ...
            <div className="relative h-full min-h-[420px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl">
              <Image src="/images/Utilities/Smart grid.jfif" alt="Utilities key features visual" fill sizes="(min-width: 1024px) 40vw, 100vw" className="object-cover object-center" quality={100} />
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#071A2F] px-6 py-24 text-white sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[1.05fr_0.95fr] items-center">
            ...
            <div className="relative h-full min-h-[420px] overflow-hidden rounded-[2rem] border border-white/10 shadow-xl">
              <Image src="/images/deployment-photo.png" alt="Utilities benefits visual" fill className="object-cover object-center" />
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-stretch">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-[#F8FBFC] p-10 shadow-sm h-full min-h-[420px] relative overflow-hidden">
              <Image src="/images/Utilities/Power transmission.jfif" alt="Utility technology" fill className="object-cover object-center" quality={100} priority />
            </div>
          </div>
        </section>
        ...
        <section className="relative isolate overflow-hidden bg-[#F8FBFC] px-6 py-24 sm:px-8 lg:px-12">
          <div className="absolute inset-0 z-0">
            <Image src="/images/Utilities/Utility infrastructure.jfif" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} />
          </div>
        ...
        <section className="relative isolate overflow-hidden px-6 py-24 sm:px-8 lg:px-12">
          <div className="absolute inset-0 z-0">
            <Image src="/images/Utilities/Power transmission.jfif" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} />
          </div>
          <div className="relative z-10 mx-auto max-w-7xl">
            <SectionHeading
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              {relatedIndustries.map((industry) => (
                ...
                >
                  ...
                  <p className="mt-4 text-slate-200 font-medium">Explore how Tidal supports related essential services.</p>
                </Link>
              ))}
            </div>
          </div>
