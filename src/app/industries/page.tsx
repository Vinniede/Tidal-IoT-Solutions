...
const industries = [
  {
    ...
    description:
      "Connected fleets and resilient communications for high-movement operations.",
    icon: CarFront,
    image: "/images/industry-logistics.jfif",
  },
  {
    slug: "government",
    title: "Government",
    description:
      "Secure, dependable systems for public operations and critical services.",
    icon: Landmark,
    image: "/images/industry-government.jfif",
  },
  {
    slug: "banking-financial-services",
    title: "Banking & Financial Services",
    description:
      "Protected infrastructure for branch connectivity and secure data flow.",
    icon: ShieldCheck,
    image: "/images/industry-banking.jfif",
  },
  {
    slug: "utilities",
    title: "Utilities",
    description:
      "Reliable field operations and monitoring for essential services.",
    icon: Building2,
    image: "/images/industry-utilities.jfif",
  },
  {
    slug: "security-companies",
    title: "Security Companies",
    description:
      "Mission-ready infrastructure for response teams and distributed operations.",
    icon: Warehouse,
    image: "/images/industry-security.jfif",
  },
  {
    slug: "smes",
    title: "SMEs",
    description:
      "Practical modernization that scales with growth and changing demands.",
    icon: Sparkles,
    image: "/images/industry-sme.jfif",
  },
];
          ...
          <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-[0.95fr_1.05fr] items-center">
            <div className="space-y-6">
              ...
              <p className="max-w-2xl text-slate-600">
                Our work helps deliver secure operational capabilities for
                logistics, government, financial services, utilities, security
                operators, and growing businesses.
              </p>
              <div className="rounded-[2rem] border border-slate-200 bg-[#F5F6F8] p-6">
                <p className="text-sm uppercase tracking-[0.3em] text-[#00A651]">
                  Sector focus
                </p>
                <p className="mt-4 text-slate-600">
                  We design solutions that reflect the unique needs of each
                  sector while preserving consistency across governance and
                  delivery.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="relative h-full min-h-[420px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl">
                <Image
                  src="/images/industries-hero-background.jfif"
                  alt="Industry operations visual"
                  fill
              ...
              <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
                <h2 className="text-3xl font-semibold text-[#0B1F3A]">
                  Built for the industries that require trust.
                </h2>
                <p className="mt-4 text-slate-600">
                  We combine operational visibility, resilient connectivity, and
                  enterprise-grade security to meet the realities of critical
                  sectors.
                </p>
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {industries.map((industry) => {
                ...
                return (
                  <article
                    key={industry.title}
                    className="group relative min-h-[320px] overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl"
                  >
                    <div className="absolute inset-0">
                      <Image
                        src="/images/industry-sector-card-accent.png"
                        alt=""
                        fill
          ...
          <div className="relative mx-auto flex max-w-7xl flex-col gap-8 overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-10 lg:flex-row lg:items-end lg:justify-between lg:p-14">
            ...
            <div className="relative">
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-tight text-[#0B1F3A] sm:text-4xl">
                We tailor architecture to the realities of your environment and
                operating model.
              </h2>
            </div>
            <div className="relative">
