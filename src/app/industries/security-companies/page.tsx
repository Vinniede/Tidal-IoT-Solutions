...
const galleryImages = [
  {
    ...
    description: "A clear view of coordinated monitoring and fast operational response.",
  },
  {
  ...
  },
  {
    ...
    description: "Mission-ready monitoring that supports situational awareness and control.",
  },
  {
    src: "/images/Security/Access control.jfif",
    title: "Access control",
    description: "Secure access management for modern, distributed environments.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-[#F8FBFC] text-slate-700">
      ...
      <main>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="max-w-2xl text-slate-600">
                  Tidal helps security providers deploy resilient networks, protect remote teams, and maintain visibility across distributed operations.
                </p>
              ...
              <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
                ...
                <h2 className="mt-6 text-3xl font-semibold text-[#071A2F]">Resilient infrastructure for modern security operations.</h2>
                <p className="mt-4 text-slate-600">We secure voice, video, access control, and incident workflows across remote and mission-critical environments.</p>
              </div>
            </div>
            <div className="relative h-full min-h-[420px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl"><Image src="/images/Security/Security command center.jfif" alt="Security command center" fill sizes="(min-width: 1024px) 45vw, 100vw" className="object-cover object-center" quality={100} priority /></div>
          </div>
        </section>

        <section className="relative isolate overflow-hidden px-6 py-24 sm:px-8 lg:px-12">
          <div className="absolute inset-0 z-0">
            <Image src="/images/Security/Security control room.jfif" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} />
          </div>
          <div className="relative z-10 mx-auto max-w-7xl grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-stretch">
            <div className="rounded-[2rem] border border-white/10 bg-transparent p-10 text-white shadow-2xl flex flex-col gap-6">
              ...
              <div className="w-full max-w-xs rounded-lg bg-white/5 p-4">
                ...
                <p className="mt-3 text-slate-200 text-sm">Secure connectivity and monitoring for incident readiness.</p>
              </div>
            </div>
        ...
        <section className="bg-[#F8FBFC] px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[0.95fr_1.05fr] items-center">
            ...
            <div className="relative min-h-[480px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl">
              <Image src="/images/Security/CCTV monitoring.jfif" alt="Security challenges visual" fill sizes="(min-width: 1024px) 40vw, 100vw" className="object-cover object-center" quality={100} />
            </div>
          </div>
        </section>
        ...
        <section className="relative isolate overflow-hidden px-6 py-24 sm:px-8 lg:px-12">
          <div className="absolute inset-0 z-0">
            <Image src="/images/Security/Access control.jfif" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} />
          </div>
        ...
        <section className="bg-white px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[0.95fr_1.05fr] items-center">
            ...
            <div className="relative h-full min-h-[420px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl">
              <Image src="/images/Security/Surveillance dashboard.jfif" alt="Security key features visual" fill sizes="(min-width: 1024px) 40vw, 100vw" className="object-cover object-center" quality={100} />
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-[0.95fr_1.05fr] items-center">
            <div className="space-y-10">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {benefits.map((item) => (
                  <div key={item.label} className="rounded-[2rem] bg-white/10 p-6 text-slate-100 shadow-sm">
            ...
            <div className="relative h-full min-h-[420px] overflow-hidden rounded-[2rem] border border-white/10 shadow-xl">
              <Image src="/images/deployment-photo.png" alt="Security benefits visual" fill className="object-cover object-center" quality={100} />
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-stretch">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-[#F8FBFC] p-10 shadow-sm h-full min-h-[420px] relative overflow-hidden">
              <Image src="/images/Security/Security command center.jfif" alt="Security technology" fill className="object-cover object-center rounded-[1.75rem]" quality={100} priority />
            </div>
          </div>
        </section>
        ...
        <section className="relative isolate overflow-hidden bg-[#071A2F] px-6 py-24 text-white sm:px-8 lg:px-12">
          <Image src="/images/Security/Security control room.jfif" alt="Security control room" fill sizes="100vw" className="object-cover" quality={100} />
          <div className="absolute inset-0 bg-[#071A2F]/30" />
        ...
        <section className="relative isolate overflow-hidden px-6 py-24 sm:px-8 lg:px-12">
          ...
          <div className="relative z-10 mx-auto max-w-7xl text-[#00C4B3]">
            <SectionHeading
