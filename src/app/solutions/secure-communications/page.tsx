      ...
      <main>
        <section className="bg-white px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-stretch">
            <div className="relative min-h-[520px] overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-50 shadow-xl h-full sm:min-h-[640px]">
              <Image src="/images/solution-secure-communications-illustration.jpg" alt="Secure communications network" fill sizes="(min-width: 1024px) 45vw, 100vw" className="object-cover object-center" priority />
            </div>
        ...
        <section className="relative isolate overflow-hidden px-6 py-24 sm:px-8 lg:px-12">
          <div className="absolute inset-0 -z-10">
            <Image src="/images/Secure Communications/Command center.jfif" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} />
          ...
          <div className="relative mx-auto max-w-7xl grid gap-10 lg:grid-cols-[0.95fr_1.05fr] items-start">
            ...
            <div className="rounded-[2rem] border border-white/15 bg-slate-950/80 p-10 text-white shadow-2xl shadow-slate-950/25 backdrop-blur-sm">
              ...
              <div className="mt-8 overflow-hidden rounded-[1.75rem] border border-white/15">
                <Image src="/images/Secure Communications/Enterprise communications.jpg" alt="Secure communication overview" width={640} height={420} className="h-56 w-full object-cover" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#F8FBFC] px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[0.95fr_1.05fr] items-stretch">
            ...
            <div className="relative min-h-[560px] h-full overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl sm:min-h-[680px]">
              <Image src="/images/Secure Communications/Radio communication system.jfif" alt="Communication visual" fill sizes="(min-width: 1024px) 40vw, 100vw" className="object-cover" />
            </div>
          </div>
        </section>
        ...
        <section className="relative isolate overflow-hidden px-6 py-24 sm:px-8 lg:px-12">
          <div className="absolute inset-0 -z-10">
            <Image src="/images/Secure Communications/Communication tower.jfif" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} />
          </div>
        ...
        <section className="bg-white px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[0.95fr_1.05fr] items-stretch">
            ...
            <div className="relative min-h-[520px] h-full overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl sm:min-h-[640px]">
              <Image src="/images/Secure Communications/Push to talk network.jfif" alt="Push-to-talk network visual" fill sizes="(min-width: 1024px) 40vw, 100vw" className="object-cover object-center" />
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-[0.95fr_1.05fr] items-center">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-10 shadow-sm">
              <Image src="/images/Secure Communications/Push to talk network.jfif" alt="Secure push-to-talk network" width={640} height={520} className="rounded-[1.75rem] object-cover" priority />
            </div>
          </div>
        </section>
        ...
        <section className="relative isolate overflow-hidden bg-[#F8FBFC] px-6 py-24 sm:px-8 lg:px-12">
          <div className="absolute inset-0 -z-10">
            <Image src="/images/Secure Communications/Enterprise communications.jpg" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} />
          </div>
          <div className="relative mx-auto max-w-7xl text-white">
            <SectionHeading
              eyebrow="Industries"
        ...
        <section className="px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[0.95fr_1.05fr] items-center">
            ...
            <div className="relative min-h-[520px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl">
              <Image src="/images/Secure Communications/Command center.jfif" alt="Why choose Tidal visual" fill sizes="(min-width: 1024px) 40vw, 100vw" className="object-cover" />
            </div>
          </div>
        </section>
