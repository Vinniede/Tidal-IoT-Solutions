        ...
        <section className="bg-white px-6 py-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-7xl grid gap-12 lg:grid-cols-[1.05fr_0.95fr] items-center">
            <div className="space-y-4">
              <div className="relative min-h-[280px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl sm:min-h-[340px]"><Image src="/images/deployment-photo.png" alt="Infrastructure deployment" fill className="object-cover object-center" quality={100} priority /></div>
              <div className="rounded-[2rem] border border-slate-200 bg-slate-950/80 p-8 text-white shadow-sm">
                ...
                <p className="mt-4 text-slate-200">Real examples of how our infrastructure work improved continuity and resilience.</p>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <article key={study.title} className="rounded-[2rem] border border-white/10 bg-slate-950/80 p-6 text-white">
