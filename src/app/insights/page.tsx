    ...
    <div className="min-h-screen bg-[#F8FBFC] text-slate-700">
      ...
      <main>
        <section className="relative isolate overflow-hidden bg-white px-6 py-24 sm:px-8 lg:px-12">
          <Image src="/images/insights-hero-background.jfif" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} />
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="space-y-6">
              ...
              <div className="rounded-[2rem] border border-white/70 bg-slate-950/80 p-6 text-white shadow-[0_20px_45px_rgba(7,26,47,0.2)] backdrop-blur-md">
                <p className="text-sm uppercase tracking-[0.3em] text-[#8cf7ec]">Featured content</p>
            ...
            <div className="space-y-4">
              <div className="relative min-h-[280px] overflow-hidden rounded-[2rem] border border-slate-200 shadow-xl sm:min-h-[340px]"><Image src="/images/insights-hero-foreground-visual.jpg" alt="Insights visual" fill className="object-cover object-center" quality={100} priority /></div>
        ...
        <section className="relative isolate overflow-hidden px-6 pb-24 sm:px-8 lg:px-12">
          <Image src="/images/insights-featured-content-pattern.jpg" alt="" fill sizes="100vw" className="object-cover object-center" quality={100} />
          ...
          <div className="relative mx-auto max-w-7xl grid gap-6 lg:grid-cols-3">
            {insights.map((item) => (
              <article key={item.title} className="group relative min-h-[310px] overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
                <Image src="/images/insight-card-illustration.png" alt="" fill sizes="(min-width: 1024px) 30vw, 100vw" className="object-cover object-center" quality={100} />
                <Image src={item.image} alt="" fill sizes="(min-width: 1024px) 30vw, 100vw" className="object-cover object-center transition duration-500 group-hover:scale-105" quality={100} />
